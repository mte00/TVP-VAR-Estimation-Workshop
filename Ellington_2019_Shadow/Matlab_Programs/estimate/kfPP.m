function [S0,P0,P1]=kfPP(YS,XS,Q,SIG,SI,PI,T,N,L)
% function [S0,P0,P1]=kfP(YS,XS,Q,AA,H,SI,PI,T,N,L);
% This file performs the forward Kalman filter recursions for the random coefficients VAR.  R is constant.
% SI, PI are the initial values for the
...
for i = 2:T
    ...
    R = SIG; % R is shifted one period rel to observables
